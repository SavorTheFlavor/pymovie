...
class User(db.Model):
    ...
    pws = db.Column(db.String(100))  # 密码
    ...
    # print and repl(Read Eval Print Loop) both print this return string when printing this object
    def __repr__(self):
...
class Admin(db.Model):
    ...
    psw = db.Column(db.String(100))  # 管理员密码
